 ...
 ");
    ...
    public function store(Request $request)
    {
         ...
         if( $request->id ){
            ...
            ->update(['cod_contrato' => $request->contrato]);
    ...
    //         return ['temporada'=>$temporada,'codigos_libros' => $codigos_libros];
      //buscar institucion a partir del contrato
        ...
        if(count($buscarInstitucion) <= 0){
            ...
            //traer la liquidacion
                ...
                //traer liquidacion
                    $codigos_libros = DB::select("select COUNT(c.libro_idlibro) as cantidad , c.id_periodo, c.libro_idlibro, c.serie, c.contrato,l.nombre as libro, l.codigo_liquidacion, u.institucion_idInstitucion, i.nombreInstitucion  as institucion
                    from codigoslibros c, usuario u, libros_series l, institucion i 
                    where c.idusuario  = u.idusuario  
                    and c.libro_idlibro   = l.idLibro 
                    and u.institucion_idInstitucion = $institucion
                    and c.id_periodo  = $periodo 
                    and i.idInstitucion = $institucion
                    GROUP BY  c.libro_idlibro, l.nombre  ,c.serie, c.contrato, c.id_periodo,l.codigo_liquidacion, u.institucion_idInstitucion, i.nombreInstitucion
            
                ");

                return ['temporada'=>$temporadas,'codigos_libros' => $codigos_libros];
        ...
        //     $codigos_libros = DB::select("select COUNT(c.libro_idlibro) as cantidad , c.id_periodo, c.libro_idlibro, c.serie, c.contrato,l.nombre as libro, l.codigo_liquidacion, u.institucion_idInstitucion, i.nombreInstitucion 
        //     from codigoslibros c, usuario u, libros_series l, institucion i 
        //     where c.idusuario  = u.idusuario  
        //     and c.libro_idlibro   = l.idLibro 
        //     and u.institucion_idInstitucion = $idinstitucion
        //     and c.id_periodo  = $id_periodo 
        //     and i.idInstitucion = $idinstitucion
        //     GROUP BY  c.libro_idlibro, l.nombre  ,c.serie, c.contrato, c.id_periodo,l.codigo_liquidacion, u.institucion_idInstitucion, i.nombreInstitucion
