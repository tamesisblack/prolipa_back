...
class PropuestasMetodologicaController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
       ...
       foreach($proyectos as $key => $item){
           ...
           $files = DB::SELECT("SELECT f.*
               FROM propuesta_files f
               WHERE  f.propuesta_id = '$item->id'
           "); 
           $datos[$key] = [
               "id" =>              $item->id,
